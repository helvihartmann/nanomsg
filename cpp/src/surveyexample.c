...
/*copied from http://tim.dysinger.net/posts/2013-09-16-getting-started-with-nanomsg.html 20.08.2015
 gcc surveyexample.c /usr/local/lib/libnanomsg.a -o surveyexample -pthread -lanl*/
char *date ()
{
    time_t raw = time (&raw);
